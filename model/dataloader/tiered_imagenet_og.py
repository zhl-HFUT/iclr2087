...
IMAGE_PATH1 = file_dir.tiered_img
SPLIT_PATH = file_dir.tiered_split
CACHE_PATH = osp.join('/root/Projects/data/FSL/data/tieredimagenet', 'cache/')
...
class tieredImageNet_og(Dataset):
    """ Usage:
    """
    def __init__(self, setname, args, augment=False, return_id=False, 
        ...
        self.use_im_cache = False

        self.return_id = return_id
        print('Inside tiered iamgenet ', [self.use_im_cache, args.im_size])
        ...
        elif args.backbone_class == 'Res12' or args.backbone_class == 'Res12_ptcv'or args.backbone_class == 'Res12_info'or args.backbone_class == 'WRN_S2M2':
